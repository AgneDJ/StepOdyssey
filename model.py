...
def example_data():
    ...
    agne = User(user_name='Agne', user_email='agne@test.net')
    peter = User(user_name='Peter', user_email='peter@test.net')
    carl = User(user_name='Carl', user_email='carl@test.net')
    alma = User(user_name='Alma', user_email='alma@test.net')
    rachel = User(user_name='Rachel', user_email='rachel@test.net')
    jennifer = User(user_name='Jennifer', user_email='jenni@test.net')
    sean = User(user_name='Sean', user_email='sean@test.net')
    zoe = User(user_name='Zoe', user_email='zoe@test.net')
    silvia = User(user_name='Silvia', user_email='silvi_a@test.net')
    ...
    user_challenge1 = UserChallenges(
        user_id=1, challenge_id=1, start_time=2024-2-10, end_time=2024-2-7, complete=False)
    user_challenge2 = UserChallenges(
        user_id=2, challenge_id=1, start_time=2024-2-10, end_time=2024-2-11, complete=False)
    user_challenge3 = UserChallenges(
        user_id=3, challenge_id=1, start_time=2024-2-10, end_time=2024-2-11, complete=False)
    user_challenge4 = UserChallenges(
        user_id=4, challenge_id=1, start_time=2024-2-10, end_time=2024-2-11, complete=False)
    user_challenge5 = UserChallenges(
        user_id=5, challenge_id=1, start_time=2024-2-10, end_time=2024-2-11, complete=False)
    user_challenge6 = UserChallenges(
        user_id=6, challenge_id=1, start_time=2024-2-10, end_time=2024-2-11, complete=False)
    user_challenge7 = UserChallenges(
        user_id=7, challenge_id=1, start_time=2024-2-10, end_time=2024-2-11, complete=False)
    user_challenge8 = UserChallenges(
        user_id=8, challenge_id=1, start_time=2024-2-10, end_time=2024-2-11, complete=False)
    user_challenge9 = UserChallenges(
        user_id=9, challenge_id=1, start_time=2024-2-10, end_time=2024-2-11, complete=False)
    ...
    steps1 = Steps(user_id=peter.user_id, daily_total=1930, date="2024-2-10"
                   )
    steps2 = Steps(user_id=agne.user_id, daily_total=13965, date="2024-2-10"
                   )
    steps3 = Steps(user_id=carl.user_id, daily_total=1682, date="2024-2-10"
                   )
    steps4 = Steps(user_id=alma.user_id, daily_total=10328, date="2024-2-10"
                   )
    steps5 = Steps(user_id=jennifer.user_id, daily_total=40392, date="2024-2-10"
                   )
    steps6 = Steps(user_id=silvia.user_id, daily_total=254, date="2024-2-10"
                   )
    steps7 = Steps(user_id=zoe.user_id, daily_total=200, date="2024-2-10"
                   )
    steps8 = Steps(user_id=rachel.user_id, daily_total=2, date="2024-2-10"
                   )
    steps9 = Steps(user_id=sean.user_id, daily_total=2712, date="2024-2-10"
                   )
